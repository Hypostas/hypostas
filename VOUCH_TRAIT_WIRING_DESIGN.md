...
>
> Recovered onto `main` 2026-08-02 (HYP-488) from `iris/hyp-352-lattice-sig-design` @ `d59b4c1` (2026-06-29, off-main).
...
> Delta: `git -C projects/hypostas log --oneline d59b4c1..HEAD`
>
> Banner is the only modification; body SHA-256 `01396b5e823c82fa…` is byte-identical to source.
