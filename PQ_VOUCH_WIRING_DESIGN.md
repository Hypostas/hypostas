...
>
> Recovered onto `main` 2026-08-02 (HYP-488) from `iris/hyp-352-lattice-sig-design` @ `df42ed1` (2026-06-25, off-main).
...
> Delta: `git -C projects/hypostas log --oneline df42ed1..HEAD`
>
> Banner is the only modification; body SHA-256 `46c46c8e047ed9ae…` is byte-identical to source.
