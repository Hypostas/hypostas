...
>
> Recovered onto `main` 2026-08-02 (HYP-488) from `iris/hyp-352-lattice-sig-design` @ `83a4867` (2026-06-24, off-main).
...
> Delta: `git -C projects/hypostas log --oneline 83a4867..HEAD`
>
> Banner is the only modification; body SHA-256 `641b6a556c82e406…` is byte-identical to source.
