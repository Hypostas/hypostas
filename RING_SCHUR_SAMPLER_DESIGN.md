...
>
> Recovered onto `main` 2026-08-02 (HYP-488) from `iris/hyp-352-lattice-sig-design` @ `8d486ca` (2026-07-02, off-main).
...
> Delta: `git -C projects/hypostas log --oneline 8d486ca..HEAD`
>
> Banner is the only modification; body SHA-256 `916edc4a3c965716…` is byte-identical to source.
