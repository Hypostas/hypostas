...
>
> Recovered onto `main` 2026-08-02 (HYP-488) from `iris/hyp-352-lattice-sig-design` @ `4b08988` (2026-06-28, off-main).
...
> Delta: `git -C projects/hypostas log --oneline 4b08988..HEAD`
>
> Banner is the only modification; body SHA-256 `6531a65f109bc1a3…` is byte-identical to source.
